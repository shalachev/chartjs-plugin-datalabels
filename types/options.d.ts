...
interface LabelOptions {
    ...
    /**
     * The amount of blur applied to shadow under the label.
     * @default 0 (no shadow)
     * @since 0.5.0
     */
    shadowBlur?: Indexable<number> | Scriptable<number>,

    /**
     * The color of the shadow under the label.
     * @default color
     * @since 0.5.0
     */
    shadowColor?: Indexable<Color> | Scriptable<Color>,
